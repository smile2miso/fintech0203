...
<html>
	<head>
		...
		<script>
			...
			{
				if(theForm.remove.length == undel)
				{
					theForm.remove.checked = theForm.allChecked;
				}
				else
				{
			...
			function checkQty(kind, qty)
			{
				if(qty != 1)
				{
					location.href="dongCartQtyDown.dog?kind="+kind;
				}
			}
					...
					<table>
						...
						<tr>
							<td colspan="5" style="text-align: center;">
								<input type="submit" value="삭제" onclick="javascript:return checkBoxChk(this.form);form.action='dogCartRemove.dog'"/>
							</td>
						</tr>
					</table>
				</form>
